...
class A1  //super class/ parent class
...
* All the non-static member of A1 class will inherited into B1 class(A1 non-static members will be present virtually in class B1)
*/
class B1 extends A1{
	static int x=30;
	/*
